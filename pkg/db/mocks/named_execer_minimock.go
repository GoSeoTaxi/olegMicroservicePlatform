...
//go:generate minimock -i github.com/GoSeoTaxi/olegMicroservicePlatform/pkg/db.NamedExecer -o named_execer_minimock.go -n NamedExecerMock -p mocks
...
import (
	...
	mm_db "github.com/GoSeoTaxi/olegMicroservicePlatform/pkg/db"
